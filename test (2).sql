...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Nov 2019 pada 14.41
...
INSERT INTO `personal` (`personal_id`, `sekali_pertemuan`) VALUES
(1, 'Rp.100.000,00');
...
--
ALTER TABLE `kelompok`
  MODIFY `kelompok_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
